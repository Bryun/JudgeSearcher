...
namespace JudgeSearcher.Circuits
{
    public class Eighteenth : Base
    {
        ...
        public override Task<string> Execute()
        {
            ...
            {
                driver.FindElement(By.XPath("/html/body/div[4]/div/div[1]/a[1]")).Click();
                driver.FindElement(By.XPath("//*[@id='simple-banner-close-button']")).Click();
                ...
                if (driver.FindElements(By.XPath("//a[contains(text(), 'Get Courthouse Directions')]")).Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        //var address = driver.FindElements(By.XPath("//div[@class='su-tabs-pane su-u-clearfix su-u-trim']")).Select(e => e.GetAttribute("innerText")).Distinct().TakeLast(5).ToList();
